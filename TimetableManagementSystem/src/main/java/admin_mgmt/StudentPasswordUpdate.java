...
public class StudentPasswordUpdate {
    ...
    public StudentPasswordUpdate(MongoClient mongoClient) {
        this.mongoClient = mongoClient;
    }

    // Additional constructor for creating an instance without injecting MongoClient (for production use)
    public StudentPasswordUpdate() {
        // Default constructor
    }
    ...
    // Method to get the Scanner (for testing purposes)
    public Scanner getScanner() {
        return new Scanner(System.in);
    }

    public void StudentPasswordUpdateStart() {
        try {
            initializeMongoDB();
    ...
    private void initializeMongoDB() {
        try {
            // Use injected or default MongoClient
            if (mongoClient == null) {
